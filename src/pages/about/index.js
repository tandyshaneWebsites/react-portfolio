    ...
    <HelmetProvider>
      <Container className="About-header">
        ...
        <Row className="mb-5 mt-3">
          <Col lg="8">
            <h1 className="display-4 mb-4">Who are we?</h1>
        ...
        <Row className=" sec_sp">
          <Col lg="5">
            <h3 className="color_sec py-4">Website Packages</h3>
          </Col>
          <Col lg="7">
            <table className="table caption-top">
              <tbody>
                {ourpackages.map((data, i) => {
                  return (
                    <tr key={i}>
                      <th scope="row">{data.packagetitle}</th>
                      <td>{data.descritption}</td>
                      <td>{data.price}</td>
                    </tr>
                  );
                })}
        ...
        <Row className="sec_sp">
          <Col lg="5">
            <h3 className="color_sec py-4">Our Experience</h3>
          </Col>
          <Col lg="7">
            {skills.map((data, i) => {
              return (
